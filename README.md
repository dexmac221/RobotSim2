...
Modern Python recreation of the classic 1999 **RobotSim** desktop demonstrator. This edition keeps the 6-DOF manipulator behaviour while adding clean Python APIs, a refreshed OpenGL renderer, and optional Gemini Robotics perception for automatic target acquisition.
